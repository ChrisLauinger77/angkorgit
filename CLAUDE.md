...
│                       refuses binaries (NUL byte) and files over 5 MB; summaries are
│                       looked up once per oid; hunks sorted by start line
